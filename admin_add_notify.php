    ...
    <div class="main-container d-flex">
        ...
        <div class="card-body ">
            <ul class="mx-4 list-unstyled">
                <li><a href="user.php" class="text-dark text-decoration-none">หน้าเเรก</a><a href="man_notify.php" class="text-dark text-decoration-none"> / ระบบจัดการข้อมูลประชาสัมพันธ์</a><a href="admin_add_notify.php" class="text-secondary fw-blod text-decoration-none"> / เพิ่มประชาสัมพันธ์</a></li>
            </ul>
            <center>
            <div class="mt-3 col-md-8 p-5 shadow-lg">
                            <h3 class="text-center">เพิ่มประชาสัมพันธ์</h3>
                            <hr>
                                <form action="check_notify.php" method="POST" enctype="multipart/form-data">
              
                                <div class="ms-3 form-floating mt-2">
                                        <input type="text" name="n_quest" placeholder="name" required class="form-control" style="<?php echo $rad30;?>">
