    ...
    <main>
        <div class="main-container d-flex">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="h2 text-secoration  ms-3 text-dark d-flex">ระบบจัดการประเภทห้องพัก</div>
                    <hr>
                    <form class="d-flex mt-3 ms-3">
                        <input class="form-control board__hover search rounded-pill text-dark" type="search" name="search" placeholder="ค้นหาชื่อประเภทห้องพัก" aria-label="Search">
                    ...
                    <a href="admin_add_catg.php" class="nav-link active"><button class="btn board__hover ms-4 mt-2 text-white bg-warning  d-flex fw-bold pb-2 py-2" style="border-radius:20px;<?php echo $yellow_bg;?>">+ เพิ่มประเภทห้องพัก</button></a>
                        ...
                        <div class="table table-resoponsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td width="120" align="center"><?php echo $row_us['catg_name'];?></td>
                                    <?php if($row_us['catg_show']=='enable'){ ?>
                                     <td width="120" align="center"><a href="admin_change_room_en.php?catg_id=<?php echo $row_us['catg_id'];?>"><i class="fa-sharp fa-solid fa-eye text-dark"></i></a></td>
                                    <?php  }else{ ?>
                                    <td width="120" align="center"><a href="admin_change_room_ds.php?catg_id=<?php echo $row_us['catg_id'];?>"><i class="fa-sharp fa-solid fa-eye-slash text-dark"></i></a></td>
                                    <?php  } ?>
                                    <td width="120" align="center"><img src="img/<?php echo $row_us['catg_img'];?>" width="50%" height="50%" alt=""></td>
                                    <td width="120" align="center">
                                        <a href="admin_edit_catg.php?catg_id=<?php echo $row_us['catg_id'];?>" class="btn btn-warning  fw-bold text-dark">เเก้ไข</a>
                                       <a onclick="confirmDelete('<?php echo $row_us['catg_id'];?>')" class="btn btn-dark text-white fw-bold">ลบ</a>
                                    </td>
                                </tr>
                                <?php $number++;}?>
                            </table>
