...
$user1 ="SELECT * From category where catg_id = '".$_GET['catg_id']."'";
...
if(isset($_POST['btn_upload'])) {
    ...
    $sql = "UPDATE category set catg_name = '".$_POST['catg_name']."',
                        catg_img = '".$filename."'
                        where catg_id = '".$_GET['catg_id']."'";
...
<main>
    <div class="main-container d-flex">
        ...
        <ul class="mx-4 list-unstyled">
                <li><a href="user.php" class="text-dark text-decoration-none">หน้าเเรก</a><a href="man_catg.php" class="text-dark text-decoration-none"> / ระบบจัดการข้อมูลประเภทห้องพัก</a><a href="admin_edit_catg.php" class="text-secondary fw-blod text-decoration-none"> / เเก้ไขข้อมูลประเภทห้องพัก</a></li>
            </ul>
        <div class="card-body ">
            <center>
            <div class="mt-3 col-md-8 p-5 shadow-lg">
                            <h3 class="text-center">แก้ไขข้อมูลหมวดหมู่กระทู้</h3>
                            <hr>
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="ms-3 form-floating mt-2">
                                        <input type="text" name="catg_name" value="<?php echo $row_us['catg_name'];?>" placeholder="name" required class="form-control" style="<?php echo $rad30;?>">
                                        <label for="">กรุณากรอกชื่อหมวดหมู่กระทู้</label>
                                    </div>
                                    ...
                                    <div class="row p-3">
                                        <button name="btn_upload" class="btn btn-white board__hover col-md-12 text-white" style="<?php echo $yellow_bg;?>">แก้ไขข้อมูลหมวดหมู่กระทู้</button>
                                    </div>
                                </form>
                        </div>
        </div>
