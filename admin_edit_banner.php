...
$user1 ="SELECT * From banner where b_id = '".$_GET['b_id']."'";
...
if(isset($_POST['btn_upload'])) {
    ...
    $sql = "UPDATE banner set b_name = '".$_POST['b_name']."',
                        b_des = '".$_POST['b_des']."',
                        b_img = '".$filename."'
...
<main>
    <div class="main-container d-flex">
        ...
        <ul class="mx-4 list-unstyled">
                <li><a href="user.php" class="text-dark text-decoration-none">หน้าเเรก</a><a href="man_banner.php" class="text-dark text-decoration-none"> / ระบบจัดการข้อมูลพันธมิตร</a><a href="admin_edit_banner.php" class="text-secondary fw-blod text-decoration-none"> / เเก้ไขข้อมูลพันธมิตร</a></li>
            </ul>
            <center>
            <div class="mt-3 col-md-8 p-5 shadow-lg board__hover">
        <h3 class="text-center">แก้ไขข้อมูลพันธมิตร</h3>
                            <hr>
                                <form action="" method="POST" enctype="multipart/form-data">
                                    <div class="ms-3 form-floating mt-2">
                                        <input type="text" name="b_name" value="<?php echo $row_us['b_name'];?>" placeholder="name" required class="form-control" style="<?php echo $rad30;?>">
                                        <label for="">กรุณากรอกชื่อพันธมิตร</label>
                                    </div>
                                    <div class="ms-3 form-floating mt-2">
                                        <input type="text" name="b_des"  value="<?php echo $row_us['b_des'];?>" placeholder="email" required class="form-control" style="<?php echo $rad30;?>">
                                    ...
                                    <br>
                                    <div class="row p-3">
                                    <button name="btn_upload" class="btn btn-white board__hover col-md-12 text-white" style="<?php echo $yellow_bg;?>">แก้ไขข้อมูลพันธมิตร</button>
                                    </div>
                                </form>
                        </div>
        </div>
